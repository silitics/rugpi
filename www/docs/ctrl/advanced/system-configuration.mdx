...
**We may introduce breaking changes to the configuration format in minor version.**
:::
...
Rugix Ctrl's OTA update mechanism uses _slots_ to flexibly handle different OTA scenarios and requirements.
