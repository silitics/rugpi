...
While we will improve the workflow in the future, for the moment, adaptive delta updates require the manual creation of system block indices, for instance, with:
