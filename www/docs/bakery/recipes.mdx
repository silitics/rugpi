...
- `RUGIX_CONTEXT_DIR`: Rugix Bakery build context directory (typically the project directory).
...
This is an very flexible mechanism to generate all kinds of build artifacts and complementary documentation.
